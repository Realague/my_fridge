...
class CookingRecipeAddItem extends StatefulWidget {
  const CookingRecipeAddItem({required this.itemName, required this.addIngredient});

  final Function(Ingredient) addIngredient;
  final String itemName;

  @override
  State<StatefulWidget> createState() => _CookingRecipeAddItemState();
}

class _CookingRecipeAddItemState extends State<CookingRecipeAddItem> {
  _CookingRecipeAddItemState();
        ...
        child: Column(children: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Ingredient ingredient = Ingredient.fromItem(item, _quantity, context);
